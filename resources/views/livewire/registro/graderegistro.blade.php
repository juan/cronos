<div>
    <x-menubar.headermenu nameform="Registro / Cargo"/>
        ...
        <div class="flex items-center mt-4 ml-3">
            ...
            @if(count($listgrade)==0)
                <div class="p-4 mb-4 flex w-full justify-center text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800" role="alert">
                    <span class="font-medium">No existen cargos registrados.</span>
                </div>
            @else
                <x-html.tablehtml heading="No.,Cargo,Estatus,Opción">

                    @foreach($listgrade as $datatr)
                    ...
                    <form
                        ...
                        <div
                         ...
                         >
                            <x-html.inputtexhtml
                                    autofocus
                                    wire:model.defer="namegrade" id="namegrade" label="Cargo." />
                        </div>
                        @if($errors->has('namegrade'))
                            <div class="mt-0.5">
                                <x-jet-input-error message="{{ $errors->first('namegrade') }}"></x-jet-input-error>
                            </div>
                        @endif
                ...
                <x-slot name="footer">
                    <div class="flex items-center space-x-4 mt-4">
                        ...
                        <x-jet-button
                                ...
                                wire:click.prevent="savecargo" >
                            <svg   wire:loading wire:target="savecargo"
